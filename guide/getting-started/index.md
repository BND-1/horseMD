---
title: 快速开始
description: 下载、安装并第一次打开 HorseMD。
---
...
安装并打开 HorseMD 后，继续阅读[第一次启动](/getting-started/first-launch)。你将完成：
...
::: warning 只从可信来源下载
建议从 [HorseMD 官网](https://horsemd.yangsir.net/) 或 [GitHub Releases](https://github.com/BND-1/horseMD/releases/latest) 下载。不要使用来源不明的二次打包版本。
:::
