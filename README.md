...
- 表格（**单元格内可换行**、按内容自适应列宽、超宽时按需横向滚动、按住列边界可实时调宽）、**带语法高亮的代码块**、**LaTeX 数学公式**、**Mermaid 图表**、图片、任务列表、引用块
...
- [docs/release-v0.12.46.md](./docs/release-v0.12.46.md) —— v0.12.46 更新说明、安装产物、验证与关联 Issue
