...
- **浏览器式 PDF 导出中心**（`Ctrl/Cmd+Shift+E`）—— 真实分页预览，可配置纸张、横纵向、边距、缩放、目录页、书签、页眉页脚、页码和范围；公式、表格与图片按打印版排版，不带编辑器控件
...
- **设置页**（左下角齿轮）—— 排版（字号/行距/段距/页宽 + 实时预览）、字体、可组合 CSS、外观、文件与图床、云同步、快捷键、校对、语言和关于
