...
const provider = new S3Provider({ endpoint: 'https://s3.example.test', bucket: 'notes', region: 'us-east-1', accessKeyId: 'AKID', secretAccessKey: 'SECRET', prefix: 'HorseMD/test', request: async (url, init) => {
  calls.push({ url, init })
