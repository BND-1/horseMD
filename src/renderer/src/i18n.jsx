...
export const STRINGS = {
  en: {
    ...
    'settings.previewHeading': 'Live preview',
    'settings.previewBody': 'The quick brown fox jumps over the lazy dog. Adjust the sliders above — font size, line height, paragraph spacing, and page width all update this sample in real time.',
    'settings.previewListItem': 'A list item, for spacing reference.',
    ...
    'settings.imageHostDesc': 'A Typora-style custom command that receives the image file path and prints the resulting URL. Leave empty to keep pasted images local.',
    'settings.imageHostPlaceholder': 'e.g. picgo upload "/path/to/img.png"',
  ...
  zh: {
    ...
    'settings.previewHeading': '实时预览',
    'settings.previewBody': '快捷的棕色狐狸跃过懒狗。拖动上方滑块——字号、行距、段距、页宽都会实时反映在这段样本上。',
    'settings.previewListItem': '一个列表项,用于参考间距。',
    'settings.appearance': '外观',
    'settings.language': '语言',
    'settings.openThemesFolder': '打开主题目录',
    'settings.getMoreThemes': '获取更多主题',
    'settings.imageHost': '图床',
    'settings.imageHostDesc': 'Typora 式自定义命令:接收图片文件路径,输出结果 URL。留空则保持粘贴的图片为本地。',
    'settings.imageHostPlaceholder': '例如 picgo upload "/path/to/img.png"',
    'settings.about': '关于',
