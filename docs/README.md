...
| [transaction-source-sync-architecture.md](./transaction-source-sync-architecture.md) | **当前架构状态（0.13.134）**：revision-bound transaction journal、structural owner registry、共享 list/code/plain 生命周期与剩余结构族迁移门槛 |
